...
- **Vendored here:** **3D** (`assets/emoji/3d/`, 67 — the documented default, ~2 MB), **2D Colour** (`assets/emoji/color/`, 67) and **24 animated APNGs** (`assets/emoji/animated/`). Base skin tone only.
